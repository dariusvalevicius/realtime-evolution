...
def main():
    ...
    collector = subprocess.Popen(['python', 'code/collector.py', shared_drive_path, output_path, str(participant), target, condition])#, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
